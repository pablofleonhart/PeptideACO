...
class ACOR:
    ...
    def evaluator( self, x ):
        ...
        self.rotate_to( rotation, self.modified.atoms, self.modified.aminoAcids, mod )
    ...
    def initialize( self, ants, var ):
        return np.random.uniform( low = 0, high = 1, size = ( ants, var ) )
    ...
    def evolve( self ):
        ...
        initialSolution = self.initialize( self.sizeSolutions, self.numVar )
